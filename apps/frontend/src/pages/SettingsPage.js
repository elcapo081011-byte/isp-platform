...
export function SettingsPage() {
    ...
    return (_jsxs("div", { className: "p-8 max-w-lg space-y-5", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-display font-bold mb-1", children: "Configuraci\u00F3n" }), _jsx("p", { className: "text-muted text-sm", children: "Reglas de negocio y apariencia del sistema." })] }), _jsxs("div", { className: "status-panel status-panel--neutral space-y-3", children: [_jsx("p", { className: "text-sm font-medium", children: "Apariencia" }), _jsx("p", { className: "text-xs text-muted", children: "Tema y color principal \u2014 se aplican al instante en este navegador." }), _jsxs("div", { className: "flex gap-2", children: [_jsxs("button", { onClick: () => setTheme('dark'), className: `flex items-center gap-2 border rounded-md px-3 py-1.5 text-xs transition-colors ${theme === 'dark' ? 'border-signal text-ink bg-surface-raised' : 'border-border text-muted hover:text-ink'}`, children: [_jsx(Moon, { size: 12 }), " Oscuro"] }), _jsxs("button", { onClick: () => setTheme('light'), className: `flex items-center gap-2 border rounded-md px-3 py-1.5 text-xs transition-colors ${theme === 'light' ? 'border-signal text-ink bg-surface-raised' : 'border-border text-muted hover:text-ink'}`, children: [_jsx(Sun, { size: 12 }), " Claro"] })] }), _jsx("div", { className: "flex flex-wrap gap-2 pt-1", children: ACCENT_OPTIONS.map((opt) => (_jsxs("button", { onClick: () => setAccent(opt.key), className: `flex items-center gap-2 border rounded-md px-3 py-1.5 text-xs transition-colors ${accent === opt.key ? 'border-signal text-ink bg-surface-raised' : 'border-border text-muted hover:text-ink'}`, children: [_jsx("span", { className: "h-3 w-3 rounded-full shrink-0", style: { background: opt.key === 'teal' ? '#1FB6A6' : opt.key === 'indigo' ? '#6366F1' : opt.key === 'amber' ? '#E8A23D' : '#E1554F' } }), opt.label] }, opt.key))) })] }), _jsxs("div", { className: "status-panel status-panel--neutral space-y-4", children: [_jsx("p", { className: "text-sm font-medium", children: "Motor de suspensi\u00F3n" }), _jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: [_jsx(Field, { label: "D\u00EDas de gracia", value: graceDays, onChange: setGraceDays }), _jsx(Field, { label: "Avisar N d\u00EDas antes", value: notifyDays, onChange: setNotifyDays })] }), _jsx("p", { className: "text-sm font-medium pt-2 border-t border-border", children: "Umbrales de se\u00F1al \u00F3ptica (configurables, no universales)" }), _jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: [_jsx(Field, { label: "RX advertencia (dBm)", value: rxWarn, onChange: setRxWarn }), _jsx(Field, { label: "RX cr\u00EDtico (dBm)", value: rxCritical, onChange: setRxCritical })] }), _jsx("button", { onClick: save, className: "bg-signal text-base text-sm font-medium rounded-md px-4 py-2", children: "Guardar cambios" })] })] }));
}
